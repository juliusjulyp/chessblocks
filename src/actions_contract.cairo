...
mod actions {
    ...
    use starknet::ContractAddress;
    use chess_blocks::models::{Color, Square, PieceType, Game, GameTurn};
    use super::IActions;
    use chess_blocks::models::{is_out_of_board, is_right_piece_move, is_piece_is_mine};
...
mod tests {
    ...
    use chess_blocks::models::{Game, game, GameTurn, game_turn, Square, square, PieceType};

    use chess_blocks::actions_contract::actions;
